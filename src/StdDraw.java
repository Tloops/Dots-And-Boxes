...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    public static double xmin, ymin, xmax, ymax;//TODO change to public at 5.13
    ...
    ***************************************************************************/
    ...
    public static void setYscale(double min, double max) {
        ...
        if (size == 0.0) throw new IllegalArgumentException("the min and max are the same");
        synchronized (mouseLock) {
            ymin = max + BORDER * size;
            ymax = min - BORDER * size;
        }
    }//TODO the direction of y-axis is changed by NIE
...
*/
    ...
    *  as an argument. It can handle action keys
    ...
    public static void loading() {
    	...
    	String str = "";
		Color color;
    	StdDraw.setFont(new Font("Ink Free", 1, 60));
    	for(int t = 0; t < 8;t += 1) {
    		clear();
//    		StdDraw.picture("", "", filename);
    		str = "";
    		int x = t % 4;
    		switch(x) {
    			case 0:	color = new Color(240, 255, 240);
						break;
    			case 1:	color = new Color(255, 245, 238);
						break;
    			case 2:	color = new Color(255, 245, 238);
						break;
    			default:color = new Color(253, 245, 230);
    		}
    		setPenColor(color);
    		filledRectangle((xmin + xmax)/2, (ymin + ymax)/2, (xmax - xmin)/2, (ymin - ymax)/2);
    		setPenColor();
    		for(int i = 0; i < x; i++)
    			str += ".";
			text((xmin + xmax)/2, (ymin + ymax)/2, "Loading" + str);
			show();
			pause(100);
    	}
    }
...
//    	
//    	for (double t = 0.0; true; t += 0.02) {
//    		double x = 1*Math.sin(t);
//    	    double y = 0.6*Math.cos(t);
//    	    StdDraw.clear();
...
//    	
//    	while(true) {
//    		if(StdDraw.mouseX > 0 && StdDraw.mouseX < 1 && StdDraw.mouseY > -0.05 && StdDraw.mouseY < 0.05) {
//    			DAB[0][1] = 1;
//    			printGame(DAB);
//    		}
//    		else {
...
//    		}
//    			
//    		if(StdDraw.isMousePressed() && StdDraw.mouseX > 0 && StdDraw.mouseX < 1 && StdDraw.mouseY > -0.05 && StdDraw.mouseY < 0.05) {
//    			StdDraw.clear();
//    			DAB[0][1] = 1;
//    			printGame(DAB);
//    			break;
...
//    	
//    	StdDraw.setFont(new Font("Ink Free",0,20));
//    	while(true) {
//    		char c = '\u0000';
//    		String s = "";
//    		
...
//    		for(int i = 0; i < x; i++)
//    			str += ".";
//			StdDraw.text((xmin + xmax)/2, (xmin + xmax)/2, "Loading" + str);
//			StdDraw.pause(100);
//			show();
//    	}
//    	square(0, 0, 0.4);
    	
//    	String s = "whjdshfdqwq";
//    	System.out.println(s.contains("qwq"));
//    	enableDoubleBuffering();
//    	for(double t = 0; ;t += 0.01) {
////    		clear();
//    		double x = Math.cos(t*5);
//    		double y = Math.sin(t*5);
//    		setPenColor(255-((int)t%255), 255-((int)(t*19)%255), 255-((int)(t*5)%255));
//    		for(double i = 0.1 ; i <= 1.2; i += 0.1)
//    			filledCircle(x*i, y*i, 0.06);
//    		show();
//    		pause(2);
//    	}
    }
